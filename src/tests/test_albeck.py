...
def test_albeck11c():
    from earm.albeck_11c import model

    from ..albeck import Albeck11c as Model
    ...
    mapping = {
        ...
        Smac(bf=1, state="A") % XIAP(bf=1): Model.intrinsic.r_Smac_XIAP.AB,
        # NEw
        Bax(bf=1, s1=2, s2=3, state='A') % Bax(bf=None, s1=4, s2=2, state='A') % Bax(bf=None, s1=5, s2=4, state='A') % Bax(bf=None, s1=3, s2=5, state='A') % Bcl2(bf=1): Model.r_Bax4_Bcl2.AB,
        Bax(bf=1, s1=2, s2=3, state='A') % Bax(bf=None, s1=4, s2=2, state='A') % Bax(bf=None, s1=5, s2=4, state='A') % Bax(bf=None, s1=3, s2=5, state='A') % CytoC(bf=1, state='M'): Model.r_CytoC_pore.ES,
        Bax(bf=1, s1=2, s2=3, state='A') % Bax(bf=None, s1=4, s2=2, state='A') % Bax(bf=None, s1=5, s2=4, state='A') % Bax(bf=None, s1=3, s2=5, state='A') % Smac(bf=1, state='M'): Model.r_Smac_pore.ES,
        Bax(bf=1, s1=None, s2=2, state='A') % Bax(bf=None, s1=2, s2=None, state='A') % Bcl2(bf=1): Model.r_Bax2_Bcl2.AB,
        Bax(bf=None, s1=1, s2=2, state='A') % Bax(bf=None, s1=3, s2=1, state='A') % Bax(bf=None, s1=4, s2=3, state='A') % Bax(bf=None, s1=2, s2=4, state='A'): Model.Bax_A4,
...
def test_albeck11d():
    from earm.albeck_11d import model

    from ..albeck import Albeck11d as Model
    ...
    mapping = {
        ...
        Apop(bf=1) % C3(bf=1, state="pro"): Model.intrinsic.r_Apop_C3.ES,
        Apop(bf=1) % XIAP(bf=1): Model.intrinsic.r_Apop_XIAP.AB,
        Bax(bf=1, s1=None, s2=None, state="M")
        % Bcl2(bf=1): Model.r_Bax_Bcl2.AB,
        Bax(bf=1, s1=None, s2=None, state="A")
        % CytoC(bf=1, state="M"): Model.r_CytoC_pore.ES,
        Bax(bf=1, s1=None, s2=None, state="A")
        ...
        Smac(bf=1, state="A") % XIAP(bf=1): Model.intrinsic.r_Smac_XIAP.AB,
        # NEw
        Bax(bf=1, s1=2, s2=3, state='M') % Bax(bf=None, s1=4, s2=2, state='M') % Bax(bf=None, s1=5, s2=4, state='M') % Bax(bf=None, s1=3, s2=5, state='M') % Bcl2(bf=1): Model.r_Bax4_Bcl2.AB,
        Bax(bf=1, s1=2, s2=3, state='M') % Bax(bf=None, s1=4, s2=2, state='M') % Bax(bf=None, s1=5, s2=4, state='M') % Bax(bf=None, s1=3, s2=5, state='M') % CytoC(bf=1, state='M'): Model.r_CytoC_pore.ES,
        Bax(bf=1, s1=2, s2=3, state='M') % Bax(bf=None, s1=4, s2=2, state='M') % Bax(bf=None, s1=5, s2=4, state='M') % Bax(bf=None, s1=3, s2=5, state='M') % Smac(bf=1, state='M'): Model.r_Smac_pore.ES,
        Bax(bf=1, s1=None, s2=2, state='M') % Bax(bf=None, s1=2, s2=None, state='M') % Bcl2(bf=1): Model.r_Bax2_Bcl2.AB,
        Bax(bf=None, s1=1, s2=2, state='M') % Bax(bf=None, s1=3, s2=1, state='M') % Bax(bf=None, s1=4, s2=3, state='M') % Bax(bf=None, s1=2, s2=4, state='M'): Model.Bax_M4,
        Bax(bf=None, s1=1, s2=None, state='M') % Bax(bf=None, s1=None, s2=1, state='M'): Model.Bax_M2,
...
def test_albeck11e():
    ...
    from ..albeck import Albeck11e as Model
    ...
    mapping = {
        ...
        Bax(bf=None, s1=1, s2=None, state='M') % Bax(bf=None, s1=None, s2=1, state='M'): Model.Bax_M2,
        Bax(bf=None, s1=None, s2=None, state='M'): Model.mitocondria.Bax_M,
        Bax(bf=1, s1=2, s2=3, state='M') % Bax(bf=None, s1=4, s2=2, state='M') % Bax(bf=None, s1=5, s2=4, state='M') % Bax(bf=None, s1=3, s2=5, state='M') % Mito(bf=1, state='I'): Model.r_Bax4_Mito.AB,
...
def test_albeck11f():
    ...
    from ..albeck import Albeck11f as Model
