...
def test_mito(stimuli):
    mapping = {
        ...
        ARM.arm.caspam.sCas3.dimer: ARM_split.caspam.sCas3.dimer,
        ARM.arm.caspam.sCas3.monomer: ARM_split.caspam.sCas3.monomer,
        ARM.arm.caspam.sCas8.dimer: ARM_split.caspam.sCas8.dimer,
        ARM.arm.caspam.sCas8.monomer: ARM_split.caspam.sCas8.monomer,
        ARM.arm.caspam.sCas9.dimer: ARM_split.caspam.sCas9.dimer,
        ARM.arm.caspam.sCas9.monomer: ARM_split.caspam.sCas9.monomer,
        ARM.arm.r_sCas3.r.ES: ARM_split.r_sCas3.r.ES,
        ARM.arm.r_sCas8.r.ES: ARM_split.r_sCas8.r.ES,
        ARM.arm.r_sCas9_Apaf.r.ES: ARM_split.r_sCas9_Apaf.r.ES,
        ARM.arm.r_sCas9_Apop.r.ES: ARM_split.r_sCas9_Apop.r.ES,
    }
